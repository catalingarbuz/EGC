...
void Lab1::Init()
{
    ...
    figure1 = meshes["box"];
    figure2 = meshes["sphere"];
    figure3 = meshes["teapot"];
    figure_aux = figure2;
...
void Lab1::Update(float deltaTimeSeconds)
{
    ...
    // Render the object
    RenderMesh(figure1, glm::vec3(1, 0.5f, 0), glm::vec3(0.5f));


    // Render the object again but with different properties
    RenderMesh(figure1, glm::vec3(-1, 0.5f, 0));

    // Render the oject which was loaded previously
    RenderMesh(figure2, glm::vec3(y_sph, z_sph, x_sph));
...
void Lab1::OnKeyPress(int key, int mods)
{
    ...
    if (key == GLFW_KEY_C) {
        ...
        else if (change_obj == 1) {
            figure2 = figure3;
            change_obj++;
        }
        else if (change_obj == 2) {
            figure2 = figure_aux;
            change_obj = 0;
        }
    }
