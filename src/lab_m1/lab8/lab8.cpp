...
{
    {
        ...
        RenderSimpleMesh(meshes["sphere"], shaders["LabShader"], modelMatrix, glm::vec3(0.968f, 0.231f, 0.631f));
...

    {
        ...
        // TODO(student): Add or change the object colors
        RenderSimpleMesh(meshes["box"], shaders["LabShader"], modelMatrix, glm::vec3(0.992f, 0.705f, 0.05f));
...

    {
        ...
        RenderSimpleMesh(meshes["box"], shaders["LabShader"], modelMatrix, glm::vec3(0.529f, 0.992f, 0.05f));
    }
    ...
    // Render ground
    {
        ...
        // TODO(student): Add or change the object colors
        RenderSimpleMesh(meshes["plane"], shaders["LabShader"], modelMatrix , glm::vec3(0.772f, 0.839f, 0.886f));
...
void Lab8::RenderSimpleMesh(Mesh *mesh, Shader *shader, const glm::mat4 & modelMatrix, const glm::vec3 &color)
{
    ...
    int type_spotlight = glGetUniformLocation(shader->program, "type_spotlight");
    glUniform1i(type_spotlight, type_of_light);

    int cutoff_angle_loc = glGetUniformLocation(shader->program, "cut_off_angle");
    glUniform1f(cutoff_angle_loc, cutoff_angle);
    // Bind model matrix
