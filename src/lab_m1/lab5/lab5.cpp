...
void Lab5::Init()
{
    ...
    camera2->Set(glm::vec3(2.5f, 4, -4.5f), glm::vec3(0, 1, 0), glm::vec3(0, 1, 0));
...
void Lab5::Update(float deltaTimeSeconds)
{
    ...
    {
        glm::mat4 modelMatrix = glm::mat4(1);
        modelMatrix = glm::translate(modelMatrix, glm::vec3(1.5f, 2, -1));
        modelMatrix = glm::scale(modelMatrix, glm::vec3(0.8f));
        modelMatrix = glm::rotate(modelMatrix, RADIANS(30.0f), glm::vec3(1, 1, 0));
        RenderMesh(meshes["box"], shaders["VertexNormal"], modelMatrix);
    }

    {
        glm::mat4 modelMatrix = glm::mat4(1);
        modelMatrix = glm::translate(modelMatrix, glm::vec3(-1.3f, 2, -1.2f));
...
void Lab5::OnInputUpdate(float deltaTime, int mods)
{
    ...
    if (window->MouseHold(GLFW_MOUSE_BUTTON_RIGHT))
    {
        ...
        if (window->KeyHold(GLFW_KEY_S)) {
            camera->TranslateBackward(cameraSpeed * deltaTime);
