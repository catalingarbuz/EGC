    ...
    class Camera
    {
     public:
        ...
        void TranslateForward(float distance)
        {
            ...
            // `MoveForward()`?
            position = position + glm::normalize(this->forward) * distance;
        ...
        void TranslateUpward(float distance)
        {
            ...
            position = position + glm::normalize(this->up) * distance;
        }
        ...
        {
            glm::vec4 newVec = glm::rotate(glm::mat4(1.f), angle, right) * glm::vec4(forward, 0);
        ...
        void RotateFirstPerson_OY(float angle)
        {
            ...
            glm::vec4 newVec = glm::rotate(glm::mat4(1.f), angle, glm::vec3(0, 1, 0)) * glm::vec4(forward, 0);
            forward = glm::normalize(glm::vec3(newVec));

            newVec = glm::rotate(glm::mat4(1.f), angle, glm::vec3(0, 1, 0)) * glm::vec4(right, 0);
        ...
        void RotateFirstPerson_OZ(float angle)
        {
            ...
            glm::vec4 newVec = glm::rotate(glm::mat4(1.f), angle, glm::vec3(0, 1, 0)) * glm::vec4(right, 1);
            right = glm::normalize(glm::vec3(newVec));

            newVec = glm::rotate(glm::mat4(1.f), angle, forward) * glm::vec4(up, 0);
            forward = glm::normalize(glm::vec3(newVec));
