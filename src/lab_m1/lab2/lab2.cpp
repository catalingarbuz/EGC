...
void Lab2::Init()
{
    ...
    // Create a mesh box using custom data
    {
        ...
        {
            VertexFormat(glm::vec3(-1, -1,  1), glm::vec3(0.2f, 0.9f, 0.5f)),
            VertexFormat(glm::vec3(0, -1, 1), glm::vec3(0.2f, 0.9f, 0.5f)),
            VertexFormat(glm::vec3(-1, 0, 1), glm::vec3(0.2f, 0.9f, 0.5f)),
            VertexFormat(glm::vec3(0, 0, 1), glm::vec3(0.2f, 0.9f, 0.5f)),
            VertexFormat(glm::vec3(-1, -1, 0), glm::vec3(0.2f, 0.9f, 0.5f)),
            VertexFormat(glm::vec3(0, -1, 0), glm::vec3(0.2f, 0.9f, 0.5f)),
            VertexFormat(glm::vec3(-1, 0, 0), glm::vec3(0.2f, 0.9f, 0.5f)),
            VertexFormat(glm::vec3(0, 0, 0), glm::vec3(0.2f, 0.9f, 0.5f))
    ...
    {
        vector<VertexFormat> tetrahedro_vertices
        {
           VertexFormat(glm::vec3(0, 0, 0), glm::vec3(0.9f, 0.4f, 0)),
           VertexFormat(glm::vec3(0, 0, 1), glm::vec3(0.9f, 0.4f, 0)),
           VertexFormat(glm::vec3(0, 1, 0), glm::vec3(0.9f, 0.4f, 0)),
           VertexFormat(glm::vec3(1, 0, 0), glm::vec3(0.9f, 0.4f, 0))
        };

        vector<unsigned int> tetrahedro_indices
        {
            0, 1, 2,
            1, 3, 2,
            2, 3, 0,
        ...
        CreateMesh("tetrahedron", tetrahedro_vertices, tetrahedro_indices);
    }
    ...
    // opposing vertex orientations.
    {
        ...
        CreateMesh("square", square_vertices, square_indices);
    }

    {
        vector<VertexFormat> vertices_bonus
        {
            ...
            VertexFormat(glm::vec3(0, 0, 0), glm::vec3(1, 0.5f, 1)),
            VertexFormat(glm::vec3(-1, -1, 0), glm::vec3(1, 0.5f, 1)),
            VertexFormat(glm::vec3(0, -1, 0), glm::vec3(1, 0.5f, 1)),
            VertexFormat(glm::vec3(-1, 0, 0), glm::vec3(1, 0.5f, 1)),
            VertexFormat(glm::vec3(-1, 0, 1), glm::vec3(0, 1, 0)),
        ...
        {
            0, 2, 4,    // indices for first triangle
            4, 2, 7,
            12, 8, 1,
            12, 1, 21,
            9, 10, 3,
        ...
        CreateMesh("bonus_square", vertices_bonus, indices_bonus);
    }
}
...
void Lab2::Update(float deltaTimeSeconds)
{
    ...
    RenderMesh(meshes["cube_B"], shaders["VertexColor"], glm::vec3(1, 0.5f, 0), glm::vec3(0.5f));
    // TODO(student): Draw the tetrahedron
    RenderMesh(meshes["tetrahedron"], shaders["VertexColor"], glm::vec3(2, 0, 0), glm::vec3(0.5f));
    // TODO(student): Draw the square
    RenderMesh(meshes["square"], shaders["VertexColor"], glm::vec3(-1, 0, 0), glm::vec3(0.9f));
    // TODO(student): Disable face culling
    //BONUS
    RenderMesh(meshes["bonus_square"], shaders["VertexColor"], glm::vec3(-3, 1, 0.5), glm::vec3(1));
